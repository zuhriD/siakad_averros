...
<?php include '../../controller/guru/dashboard_controller.php'?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="timeline timeline-one-side">
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0"><?= $row['nama_kelas']?> - <?= $row['nama_mapel']?></h6>
                ...
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Tidak ada jadwal hari ini</h6>
                  </div>
                </div>
                </div>
                <?php } ?>
