        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              <h1 class="text-white mb-2 mt-5">Welcome To Siakad Averros</h1>
              <p class="text-lead text-white">Ini adalah website Sistem Informasi Akademik SMK Averros Malang</p>
            </div>
          </div>
        </div>
      </div>
